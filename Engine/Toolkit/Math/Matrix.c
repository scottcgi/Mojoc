...
//  for (int i = 0; i < 4; i++)
//	{
//      outVector4->v[i] = matrix4->m[i/* + 4 * 0*/] * x + matrix4->m[i + 4/*4 * 1*/] * y + matrix4->m[i + 8/*4 * 2*/] * z + matrix4->m[i + 12/*4 * 3*/] * w;
//  }
}
...
//    for (int i = 0; i < 3; i++)
//	  {
//    	outVector3->v[i] = matrix4->m[i/* + 4 * 0*/] * x + matrix4->m[i + 4/*4 * 1*/] * y + matrix4->m[i + 8/*4 * 2*/] * z + matrix4->m[i + 12/*4 * 3*/];
//    }
}
...
//    for (int i = 0; i < 2; i++)
//	  {
//    	outVector2->v[i] = matrix4->m[i/* + 4 * 0*/] * x + matrix4->m[i + 4/*4 * 1*/] * y + matrix4->m[i + 8/*4 * 2*/] + matrix4->m[i + 12/*4 * 3*/];
//    }
}
